...
% Toolbox(TM), and Statistics and Machine Learning Toolbox(TM).
...
% 
% cifar = {trainingImages, trainingLabels, testImages, testLabels};
% 
% save('cifar.mat','cifar')

load('cifar.mat')

[trainingImages, trainingLabels, testImages, testLabels] = deal(cifar{:});
...
trainingImages(:,:,:,end-30000+1:end) = [];
trainingLabels(end-30000+1:end) = [];
testImages(:,:,:,end-5000+1:end) = [];
testLabels(end-5000+1:end) = [];
